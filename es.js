var translations_es = {
  ...
  introduction: `<h3>Introducción</h3>El CO2 es un gas de efecto invernadero producido en muchos casos como un subproducto industrial, el cual es actualmente emitido a la atmósfera en la mayoría de los procesos que lo producen. Sin embargo, este gas tiene el potencial de ser usado como materia prima para productos Power-to-X (PtX) que contienen carbono en sus moléculas, como es el caso del e-metanol o de los combustibles sintéticos (e-fuels).  La competitividad de estos productos puede estar altamente afectada por la disponibilidad y la calidad de la fuente de CO2 que se utilizará.
  El presente mapa tiene como objetivo identificar fuentes de carbono (en forma de CO2) en Argentina para colaborar en la búsqueda de oportunidades para desarrollar proyectos de PtX en el país. Para ello, se muestran las principales fuentes puntuales de CO2 en Argentina, indicando su ubicación, tipo de fuente y tamaño.  `,
...
<br>
  <b>Cemento</b>
  <br>Valor estimado con la capacidad de produccion de clincker [9], un factor de clincker de 0,681 y un factor de emisión promedio de 0,519 toneladas de CO2 por toneladas de cemento [10]. 
<br>
  <b>Celulosa y papel</b>
  Datos de capacidad anual de producción y factor de utilización obtenidos del Relevamiento 2020 de la industria de la celulosa y el papel[11] y un factor de emisión promedio de 2,5 toneladas de CO2 por toneladas de celulosa estimación realizada por [12].
<br>
  <b>Termoeléctrica</b>
...
<br>
  ...
  <br>[3]	“Climate Trace.” [Online]. Available: https://climatetrace.org/map/argentina-manufacturing-co2
  ...
  Dado que la información pública disponible sobre emisiones de CO2 es limitada, en algunos casos fue necesario realizar una estimación usando un factor de emisiones asumido. Por lo tanto, el valor de emisiones presentado puede no ser totalmente coincidente con el valor real para algunas de las fuentes identificadas. \n
